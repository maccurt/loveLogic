...
import { BulletPointList, Category } from "./category/Category";
import { countBy, sortBy } from "lodash-es";
import { Business, CategoryId } from "../business-domain/Business";
...
export class CategoryService {
  ...
  getCategoryList = (): Observable<Category[]> => {
    return of(categroryListMock);
  }
  
  getDistinctCategoryForEnityList(categoryIdList: CategoryId[]): Category[] {
